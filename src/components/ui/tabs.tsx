...
>(({ className, ...props }, ref) => (
	<TabsPrimitive.List
		ref={ref}
		className={cn(
			"inline-flex h-9 items-center justify-center rounded-lg bg-gray-100 p-1 text-black", // Updated background and text color
			className
		)}
		{...props}
	/>
...
>(({ className, ...props }, ref) => (
	<TabsPrimitive.Trigger
		...
		className={cn(
			...
			"data-[state=active]:bg-locker-600 data-[state=active]:text-white data-[state=active]:shadow", // Updated selected state styles
			className
		)}
		{...props}
	/>
