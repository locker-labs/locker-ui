		...
		<>
			...
			<div>
				<p className="mb-3 text-3xl font-bold">
					<p className="bg-gradient-to-r from-secondary-200 to-primary-200 bg-clip-text text-transparent">
						Save and invest
					</p>{" "}
					<p>every time you get paid</p>
				</p>
		...
		<main className="xxs:px-4 xxs:py-4 lg:px-6 lg:pb-12 xl:px-24">
			<div className="mb-24 grid grid-flow-row-dense gap-y-2 bg-light-100 text-dark-500  sm:grid-cols-2 sm:gap-x-12 xl:gap-x-36">
				...
				<div className="grid space-y-8 xxs:grid-cols-1 xs:grid-cols-8">
					<Suspense fallback={<Loading />}>
						<div className="xxs:mt-8 xs:col-span-6 xs:col-start-2 sm:col-span-8 sm:mb-2 sm:mt-0">
